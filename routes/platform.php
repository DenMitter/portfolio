...
// Platform > System > Projects
Route::screen('projects', ProjectListScreen::class)->name('platform.project.list');
Route::put('projects/{project}/update', [ProjectListScreen::class, 'update'])->name('admin.projects.update');

// Platform > System > Tags
Route::screen('tags', TagListScreen::class)->name('platform.tag.list');
Route::put('tags/{tag}/update', [ProjectListScreen::class, 'update'])->name('admin.tags.update');
