                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group" data-select2-id="29">
                        ...
                        <select class="select2 select2-hidden-accessible" name="tag_ids[]" multiple="" data-placeholder="Виберіть тег" data-dropdown-css-class="select2-green" style="width: 100%;" data-select2-id="15" tabindex="-1" aria-hidden="true">
                           @foreach ($tags as $tag)
                            <option {{ is_array($project->tags->pluck('id')->toArray()) && in_array($tag->id, $project->tags->pluck('id')->toArray()) ? ' selected' : '' }} value="{{ $tag->id }}">{{ $tag->title }}</option>
                           @endforeach
                        </select>
                        </div>
                     </div>
                     ...
                     <div class="new-user-info">
                        <div class="row">
                           <div class="form-group col-md-12">
                              ...
                              <input name="title" type="text" class="form-control" id="fname" placeholder="Title" value="{{ $project->title }}">
                           ...
                           <div class="form-group col-md-12">
                              ...
                              <input name="description" type="text" class="form-control" id="cname" placeholder="Description" value="{{ $project->description }}">
                           ...
                           <div class="form-group col-md-12">
                              ...
                              <input name="view_link" type="text" class="form-control" placeholder="Link" value="{{ $project->view_link }}">
                        ...
                        {{-- <div class="checkbox form-label">
                           <input name="is_published" type="checkbox" id="cbx" style="display: none;" value="1" {{ $project->is_published ? 'checked' : '' }}">
                        ...
                        <div class="form-group">
                          <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" id="switch2" checked="{{ $project->is_published ? 'checked' : '' }}">
                            <label class="form-check-label pl-2" for="switch2">Is Published</label>
                          </div>
                        </div>
