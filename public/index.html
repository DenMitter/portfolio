...
<body>
        ...
        <section class="projects">
            ...
            <div class="projects__cards">
                ...
                <div class="projects__card">
                    <img src="images/musicpich.png" alt="Card image">
                    ...
                    <h4 class="projects__card-title">Musicpich</h4>
                    <p class="projects__card-description">Site with music</p>
                    <div class="buttons">
                ...
                <!-- Project -->
                <div class="projects__card">
                    <img src="images/first_portfolio.png" alt="Card image">
                    <div class="projects__card-tehnology">
                        <p>HTML</p>
                        <p>CSS</p>
                    </div>
                    <h4 class="projects__card-title">First portfolio</h4>
                    <p class="projects__card-description">Site portfolio</p>
                    <div class="buttons">
                        <a href="" class="button">Live <~></a>
                    </div>
                </div>
    ...
    <div class="container">
        <footer>
            ...
            <p class="subtitle">© Copyright 2023. Made by Bogdan</p>
        </footer>
    </div>
